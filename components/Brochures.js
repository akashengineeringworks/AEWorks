    ...
    return (
        <>
            <div className="flex flex-wrap gap-6 justify-center bg-gray-300 rounded-lg">
                <embed src={Stationary} height="800" width="700" className="md:scale-95 sm:scale-75" />
                <embed src={OrangePeel} height="800" width="700" className="md:scale-95 sm:scale-75" />
            </div>
        </>
    );
}